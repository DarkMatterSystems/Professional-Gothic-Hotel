...
/* Simulator Room Device Display Event */
...
{
    #if ADM_PROBE
    adm_probe_enter(ADM_PROBE_GROUP_SIMULATOR, "adm_sim_display_event_room_device_device_update");
    #endif
    ...
    if (
        ...
        printf(" - Room_Device[");
        printf("%d", ent_room_device->identity);
    ...
    #if ADM_PROBE
    adm_probe_leave(ADM_PROBE_GROUP_SIMULATOR, "adm_sim_display_event_room_device_device_update");
    #endif
}
